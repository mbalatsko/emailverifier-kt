...
class EmailVerifierLocalTest {
    ...
    @Test
    fun `integration passes and free fails`() =
        runTest {
            val verifier = buildVerifier(hasMx = true)
    ...
    @Test
    fun `integration passes and role-based fails`() =
        runTest {
            val verifier = buildVerifier(hasMx = true)
...
class EmailVerifierOnlineTest {
    @Test
    fun `integration passes all checks online and but fails gravatar and free`() =
        runTest {
            val onlineEmailVerifier = emailVerifier { }
